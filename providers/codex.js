const commands = [
  ...
  },
  {
    ...
    detail: 'Parent command for Model Context Protocol server management. Subcommands: add, get, list, remove, login, logout.',
    example: 'codex mcp list\ncodex mcp add --url https://mcp.example.com',
  },
  {
    name: 'codex mcp add',
    args: '<name> (--url <url> | -- <command...>)',
    desc: 'Add an MCP server to global config',
    detail: 'Registers a new MCP server in ~/.codex/config.toml. Use --url for a streamable HTTP server or pass a command after -- for a stdio server. Optional flags: --env KEY=VALUE (stdio only), --bearer-token-env-var (HTTP only), --oauth-client-id, --oauth-resource. Automatically starts OAuth flow if the server supports it.',
    example: 'codex mcp add my-tool -- npx -y my-mcp-tool\ncodex mcp add my-api --url https://mcp.example.com\ncodex mcp add my-api --url https://mcp.example.com --bearer-token-env-var MY_TOKEN',
  },
  {
    name: 'codex mcp get',
    args: '<name>',
    desc: 'Show configuration of a single MCP server',
    detail: 'Displays the transport, enabled/disabled state, tool allow/deny lists, and OAuth status for the named MCP server. Use --json for machine-readable output.',
    example: 'codex mcp get my-tool\ncodex mcp get my-tool --json',
  },
  {
    name: 'codex mcp list',
    args: '',
    desc: 'List configured MCP servers',
    detail: 'Prints all MCP servers from ~/.codex/config.toml with their transport type, command or URL, status, and OAuth auth status. Use --json for machine-readable output.',
    example: 'codex mcp list\ncodex mcp list --json',
  },
  {
    name: 'codex mcp remove',
    args: '<name>',
    desc: 'Remove an MCP server from global config',
    detail: 'Deletes the named MCP server entry from ~/.codex/config.toml.',
    example: 'codex mcp remove my-tool',
  },
  {
    name: 'codex mcp login',
    args: '<name>',
    desc: 'Authenticate with an MCP server via OAuth',
    detail: 'Performs an OAuth login flow for the named streamable HTTP MCP server. Use --scopes to request specific OAuth scopes (comma-separated). Only supported for streamable HTTP transports.',
    example: 'codex mcp login my-api\ncodex mcp login my-api --scopes read,write',
  },
  {
    name: 'codex mcp logout',
    args: '<name>',
    desc: 'Remove stored OAuth credentials for an MCP server',
    detail: 'Deletes the persisted OAuth tokens for the named streamable HTTP MCP server. Only supported for streamable HTTP transports.',
    example: 'codex mcp logout my-api',
  },
  {
  ...
  },
  {
    ...
    detail: 'Lists recent Codex Cloud tasks. Filter by environment with --env, paginate with --cursor, limit results with --limit (1-20, default 20). Use --json for structured output.',
    example: 'codex cloud list\ncodex cloud list --env prod --json',
  },
  {
    name: 'codex cloud status',
    args: '<task-id>',
    desc: 'Show the status of a Codex Cloud task',
    detail: 'Displays the current status and details for the specified Codex Cloud task identifier.',
    example: 'codex cloud status abc123',
  },
  {
    name: 'codex cloud apply',
    args: '<task-id>',
    desc: 'Apply a Codex Cloud task diff locally',
    detail: 'Downloads the diff for the specified Codex Cloud task and applies it to the local workspace using git apply. Use --attempt N to select a specific best-of-N attempt (1-based).',
    example: 'codex cloud apply abc123\ncodex cloud apply abc123 --attempt 2',
  },
  {
    name: 'codex cloud diff',
    args: '<task-id>',
    desc: 'Show the unified diff for a Codex Cloud task',
    detail: 'Prints the unified diff produced by the specified Codex Cloud task. Use --attempt N to select a specific best-of-N attempt (1-based).',
    example: 'codex cloud diff abc123\ncodex cloud diff abc123 --attempt 2',
  },
  {
    name: 'codex apply',
    args: '<task-id>',
  ...
  },
  {
    name: 'codex plugin',
    args: '',
    desc: 'Manage Codex plugins',
    detail: 'Parent command for Codex plugin management. Subcommands: add, list, marketplace, remove.',
    example: 'codex plugin list\ncodex plugin add sample@debug',
  },
  {
    name: 'codex plugin add',
    args: '<plugin[@marketplace]>',
    desc: 'Install a plugin from a marketplace snapshot',
    detail: 'Installs a plugin from a configured marketplace snapshot. Pass PLUGIN@MARKETPLACE as the selector, or use --marketplace MARKETPLACE separately. Use --json for structured output.',
    example: 'codex plugin add sample@debug\ncodex plugin add sample --marketplace debug',
  },
  {
    name: 'codex plugin list',
    args: '',
    desc: 'List available plugins from marketplace snapshots',
    detail: 'Lists all plugins available from the currently configured marketplace snapshots. Use --json for structured output.',
    example: 'codex plugin list\ncodex plugin list --json',
  },
  {
    name: 'codex plugin remove',
    args: '<plugin[@marketplace]>',
    desc: 'Remove an installed plugin',
    detail: 'Uninstalls a plugin and removes it from local config and cache. Pass PLUGIN@MARKETPLACE as the selector, or use --marketplace MARKETPLACE separately.',
    example: 'codex plugin remove sample@debug\ncodex plugin remove sample --marketplace debug',
  },
  {
    name: 'codex plugin marketplace',
    args: '',
    desc: 'Manage plugin marketplaces',
    detail: 'Parent command for plugin marketplace management. Subcommands: add (register a new marketplace source), list (show configured marketplaces), upgrade (refresh a Git-backed marketplace), remove (deregister a marketplace source).',
    example: 'codex plugin marketplace list\ncodex plugin marketplace add openai/codex-plugins',
  },
  {
    name: 'codex plugin marketplace add',
    args: '<source>',
    desc: 'Register a new marketplace source',
    detail: 'Adds a local or Git marketplace to the configured marketplace sources. Source can be a local path, owner/repo[@ref], HTTPS Git URL, or SSH Git URL. Use --ref to specify a Git ref and --sparse for sparse checkout paths (repeatable). Use --json for structured output.',
    example: 'codex plugin marketplace add ./path/to/marketplace\ncodex plugin marketplace add owner/repo --ref main\ncodex plugin marketplace add https://github.com/owner/repo --sparse plugins/foo',
  },
  {
    name: 'codex plugin marketplace list',
    args: '',
    desc: 'List configured plugin marketplaces',
    detail: 'Shows all plugin marketplaces currently in scope and their installed roots. Use --json for structured output.',
    example: 'codex plugin marketplace list\ncodex plugin marketplace list --json',
  },
  {
    name: 'codex plugin marketplace upgrade',
    args: '[marketplace-name]',
    desc: 'Refresh Git-backed marketplace snapshots',
    detail: 'Updates configured Git marketplace snapshots to the latest configured revision. Omit MARKETPLACE_NAME to upgrade all configured Git marketplaces at once. Use --json for structured output.',
    example: 'codex plugin marketplace upgrade\ncodex plugin marketplace upgrade my-market',
  },
  {
    name: 'codex plugin marketplace remove',
    args: '<marketplace-name>',
    desc: 'Remove a configured marketplace source',
    detail: 'Deregisters a marketplace by name and removes its installed snapshot root. Use --json for structured output.',
    example: 'codex plugin marketplace remove my-market',
  },
  {
